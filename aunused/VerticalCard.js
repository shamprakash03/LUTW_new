...
const VerticalCard = ({loading, data = []}) => {
  ...
  return (
    <div
    className=" grid grid-cols-[repeat(auto-fit,minmax(260px,300px))] justify-center md:justify-between md:gap-4 overflow-x-scroll scrollbar-hidden transition-all"
  >
